                 ...
                 <div className="side-bar-box">
                    ...
                    <div className="dashboard">
                        <div className="main-app">Main App</div>
                            ...
                            <div className="dash awe-font"><i className='fas fa-user'></i>Addmissions
                            {/* <Link to="/createbatch">Addmissions</Link> */}
                            </div>
                        ...
                        <div className="dash awe-font"><i className='fas fa-users'></i>Batch Details</div>
